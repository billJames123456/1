  ...
  <a-layout id="components-layout-demo-side" style="min-height: 100vh" theme="light">
    <a-layout-sider v-model="collapsed" collapsible>
      ...
      <div class="logo">
        ...
        <!-- <img src="../assets/logo/logo.png" class="logo_img"> -->
        <!-- 条件表达式控制logo文本 -->
        <span class="logo_txt" :style="{ 'display': collapsed ? 'none' : 'inline-block' }">XueBao</span>
      </div>
...
<!-- 向子组件传入user对象 -->
      ...
      <a-layout-footer style="text-align: center">
        Smart Album ©2024 Created by Shabby王志豪20226243
      </a-layout-footer>
